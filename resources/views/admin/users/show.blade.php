        ...
        <div class="row">
            <div class="col-md-6">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <th>@lang('global.users.fields.linkedin_url')</th>
                        <td>{{ $user->linkedin_url }}</td>
                    </tr>
                    <tr>
                        <th>@lang('global.users.fields.facebook_url')</th>
                        <td>{{ $user->facebook_url }}</td>
                    </tr>
                    <tr>
                        <th>@lang('global.users.fields.twitter_url')</th>
                        <td>{{ $user->twitter_url }}</td>
                    </tr>
                    <tr>
                        <th>@lang('global.users.fields.website_url')</th>
                    ...
                    <tr>
                        <th>@lang('global.users.fields.presentation')</th>

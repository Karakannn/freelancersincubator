    ...
    <!-- Section: inner-header -->
        ...
        <div class="container pt-120 pb-60">
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="text-theme-colored2 font-36">{{$category->name}} Posts</h2>
                            ...
                            <article class="post clearfix mb-30 bg-lighter">
                                <div class="entry-header">
                                    <div class="post-thumb thumb">
                                        <img src="{{ $single_blog->header_image == '' ? 'http://placehold.it/540x480' : asset($single_blog->header_image)}}" alt="" class="img-responsive img-fullwidth">
                                    </div>
                                </div>

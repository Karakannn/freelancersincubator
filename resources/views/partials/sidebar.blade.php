        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ $request->segment(2) == 'blogs' ? 'active' : '' }}">
                <a href="{{ route('admin.blogs.index') }}">
                    <i class="fa fa-gears"></i>
                    <span class="title">@lang('global.menu.blog')</span>
                </a>
            </li>
            @endcan
            ...
            <li class="{{ $request->segment(2) == 'testimonials' ? 'active' : '' }}">
                <a href="{{ route('admin.testimonials.index') }}">
                    <i class="fa fa-gears"></i>
                    <span class="title">@lang('global.testimonials.title')</span>
                </a>
            </li>
            @endcan
...
-->
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                <li class="{{ $request->segment(2) == 'header' ? 'active active-sub' : '' }}">
                    ...
                    <li class="{{ $request->segment(2) == 'slider' ? 'active active-sub' : '' }}">

...
<div class="main-content">
            ...
            <div id="rev_slider_home_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery34" style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
                ...
                <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                    <ul>
                        ...
                        <!-- SLIDE 1 -->
                        <li data-index="rs-{{ $single_slider->id }}" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="{{ asset('uploads/' . $single_slider->image) }}" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Slide One">
                            <!-- MAIN IMAGE -->
                            <img src="{{ asset('uploads/' . $single_slider->image) }}" alt="" data-bgposition="center 20%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            <!-- LAYER NR. 1 -->
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="icon-box hover-effect features-icon-box iconbox-theme-colored bg-white border-1px text-center p-40">
                            <a class="icon icon-sm mb-20" href="#">
                                <img src="/local/resources/assets/images/icons/1.png" alt="">
                            </a>
                            <h4 class="text-uppercase font-weight-700 mt-0">@lang('global.home.HOME_BOX.HOME_BOX_1_TITLE')</h4>
                            <p>@lang('global.home.HOME_BOX.HOME_BOX_1_BODY')</p>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <div class="icon-box hover-effect features-icon-box iconbox-theme-colored bg-white border-1px text-center p-40">
                            <a class="icon icon-sm mb-20" href="#">
                                <img src="/local/resources/assets/images/icons/2.png" alt="">
                            </a>
                            <h4 class="text-uppercase font-weight-700 mt-0">@lang('global.home.HOME_BOX.HOME_BOX_2_TITLE')</h4>
                            <p>@lang('global.home.HOME_BOX.HOME_BOX_2_BODY')</p>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <div class="icon-box hover-effect features-icon-box iconbox-theme-colored bg-white border-1px text-center p-40">
                            <a class="icon icon-sm mb-20" href="#">
                                <img src="/local/resources/assets/images/icons/3.png" alt="">
                            </a>
                            <h4 class="text-uppercase font-weight-700 mt-0">@lang('global.home.HOME_BOX.HOME_BOX_3_TITLE')</h4>
                            <p>@lang('global.home.HOME_BOX.HOME_BOX_3_BODY')</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section>
        <div class="container">
            <div class="section-title text-center mb-40">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="title text-uppercase mb-5">@lang('global.home.UPCOMING_EVENTS.UPCOMING_EVENTS_TITLE')</h2>
                        <h5 class="font-16 text-gray-darkgray mt-5">@lang('global.home.UPCOMING_EVENTS.UPCOMING_EVENTS_SUBTITLE')</h5>
                    </div>
                </div>
            </div>
            <div class="section-content">
                    ...
                    <div class="col-lg-4">
                        <div class="course-single-item bg-white border-1px clearfix mb-30 cut-text">
                            <div class="course-thumb">
                                <img class="img-fullwidth img-250" alt="" src="{{ $single_course->course_image == '' ? 'http://placehold.it/360x250' : asset('uploads/' . $single_course->course_image) }}">
                            </div>
                            <div class="course-details clearfix p-20 pt-15">
                                <div class="course-top-part">
                                    <a href="{{ route('courses.show', [$single_course->slug]) }}">
                                        <h4 class="mt-5 mb-5">
                                            {{ $single_course->title }}
                                        </h4>
                                    </a>
                                    <h5 class="text-gray font-12 mt-0">{{ $single_course->start_date == '' ? '' : date('dS F', strtotime($single_course->start_date)) }} @if ($single_course->start_time) @ {{ date('h:m A', strtotime($single_course->start_time)) }} @endif EST</h5>
                                </div>
                                <p class="course-description mt-15 mb-0">
                                    {{ str_limit(strip_tags($single_course->description), $limit = 80, $end = '...') }}
                                </p>
                                @if ($single_course->name)
                                <div class="author-thumb">
                                    <img src="{{ $single_course->profile_image == '' ? 'http://placehold.it/55x55' : asset('uploads/' . $single_course->profile_image) }}" alt="" class="img-circle">
                                </div>
                                @endif
                            </div>
                        </div>
    ...
    <section class="parallax divider layer-overlay overlay-theme-colored-7" data-bg-img="http://freelancersincubator.com/imgs/bgreg.jpg" data-parallax-ratio="0.4">
        <div class="container">
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="bg-dark-transparent-4 p-30 mt-0" style="min-height: 400px;">
                            ...
                            <h4 class="font-16 text-gray-darkgray mt-5">@lang('global.home.REGISTER.REGISTER_FORM_SUBTITLE')</h4>
                            <form role="form" name="form" class="reservation-form mt-20" method="POST" action="{{ url('/register') }}">
                                {{ csrf_field() }}
                                <input type="hidden" name="redirect_url" value="{{ request('redirect_url', 'account') }}">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group mb-20">
                                            <input placeholder="@lang('global.home.REGISTER.REGISTER_FORM_NAME')" name="name" value="{{ old('name') }}" required class="form-control" type="text">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-0 mt-10">
                                            <button name="register" type="submit" class="btn btn-colored btn-theme-colored2 text-white btn-lg btn-block"> @lang('global.home.REGISTER.REGISTER_FORM_REGISTER')</button>
...
--}}
    ...
    <section class="bg-silver-light">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="title font-28 font-weight-700 text-uppercase">@lang('global.home.TESTIMONIALS.TESTIMONIALS_TITLE')</h3>
                        ...
                        <div class="item">
                            <div class="testimonial">
                                ...
                                <div class="testimonial-details mb-0 mr-0">
                                    <img alt="" src="{{ $single_testimonial->image == '' ? 'http://placehold.it/55x55' : asset('uploads/' . $single_testimonial->image) }}" class="img-thumbnail img-circle pull-left mr-15 mt-15" style="height: 55px;">
                                    <div class="author-info pt-15">
                                        <h5 class="mt-10 font-16 mb-0">
                                            {{ $single_testimonial->client }}
                                        </h5>
                                        <h6 class="mt-5">
                                            {{ $single_testimonial->position }}
                                        </h6>
                                    </div>
                                </div>
                            </div>

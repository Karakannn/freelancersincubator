...
class CoursesController extends Controller
{
    ...
    public function create()
    {
        ...
        $course_type = \DB::table('course_types')->select('id', 'value as name')->get()->pluck('name', 'id');
        
        return view('admin.courses.create', compact('teachers','course_type'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.courses.edit', compact('course', 'teachers', 'course_type'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.courses.show', compact('course', 'lessons', 'tests', 'course_type'));
    }

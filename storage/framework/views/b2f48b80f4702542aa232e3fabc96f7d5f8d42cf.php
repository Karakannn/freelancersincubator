...
<div class="panel panel-default">
    ...
    <div class="panel-body table-responsive">
        <table class="table table-bordered table-striped <?php echo e(count($info) > 0 ? 'datatable' : ''); ?> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('info_delete')): ?> <?php if( request('info_delete') != 1 ): ?> dt-select <?php endif; ?> <?php endif; ?>">
            <thead>
                <tr>
                    <th><?php echo app('translator')->getFromJson('global.info.fields.header_logo'); ?></th>
                    <th><?php echo app('translator')->getFromJson('global.info.fields.footer_logo'); ?></th>
            ...
            <tbody>
                ...
                <tr data-entry-id="<?php echo e($single_info->id); ?>">
                    ...
                    <?php endif; ?>
                    <td><?php if($single_info->image): ?><a href="<?php echo e(asset('uploads/' . $single_info->image)); ?>" target="_blank"><img class="img-square" src="<?php echo e(asset('uploads/' . $single_info->image)); ?>" /></a><?php endif; ?></td>
                    <td><?php if($single_info->footer_image): ?><a href="<?php echo e(asset('uploads/' . $single_info->footer_image)); ?>" target="_blank"><img class="img-square" src="<?php echo e(asset('uploads/' . $single_info->footer_image)); ?>" /></a><?php endif; ?></td>

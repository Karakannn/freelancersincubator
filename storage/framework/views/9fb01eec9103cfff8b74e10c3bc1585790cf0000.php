    ...
    <section class="parallax divider layer-overlay overlay-theme-colored-7" data-bg-img="<?php echo e($header['Forgot Password']->image == '' ? 'http://placehold.it/1920x1280' : asset('uploads/' . $header['Forgot Password']->image)); ?>" data-parallax-ratio="0.4" style="padding-top:100px;">
        <div class="container">
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="text-white mt-70 mt-sm-0 mb-0"><?php echo app('translator')->getFromJson('global.login.FPASS_FORM_TITLE'); ?></h3>
                        <h2 class="text-theme-colored2 font-54 mt-0"><?php echo app('translator')->getFromJson('global.login.FPASS_FORM_TITLE_2'); ?></h2>
                        <p class="text-white font-16 mb-sm-30"><?php echo app('translator')->getFromJson('global.login.FPASS_FORM_TITLE_3'); ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="bg-dark-transparent-4 p-30 mt-0" style="min-height: 400px;">
                            <h3 class="font-28 text-white mt-0"><?php echo app('translator')->getFromJson('global.login.FPASS_FORM_TITLE'); ?></h3>
                            <h4 class="font-16 text-gray-darkgray mt-5"><?php echo app('translator')->getFromJson('global.login.FPASS_FORM_TITLE_5'); ?></h4>

...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="<?php echo e($request->segment(2) == 'blogs' ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.blogs.index')); ?>">
                    <i class="fa fa-gears"></i>
                    <span class="title"><?php echo app('translator')->getFromJson('global.menu.blog'); ?></span>
                </a>
            </li>
            <?php endif; ?>
            <li class="<?php echo e($request->segment(2) == 'category' ? 'active' : ''); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('testimonials_access')): ?>
            <li class="<?php echo e($request->segment(2) == 'testimonials' ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.testimonials.index')); ?>">
                    <i class="fa fa-gears"></i>
                    <span class="title"><?php echo app('translator')->getFromJson('global.testimonials.title'); ?></span>
                </a>
            </li>
            <?php endif; ?>
...
-->
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-users"></i>
                    <span class="title"><?php echo app('translator')->getFromJson('global.settings.title'); ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                <li class="<?php echo e($request->segment(2) == 'header' ? 'active active-sub' : ''); ?>">
                        <a href="<?php echo e(route('admin.header.index')); ?>">
                            <i class="fa fa-briefcase"></i>
                            <span class="title">
                                <?php echo app('translator')->getFromJson('global.header.title'); ?>
                            </span>
                        </a>
                    </li>
                    <li class="<?php echo e($request->segment(2) == 'slider' ? 'active active-sub' : ''); ?>">
                        <a href="<?php echo e(route('admin.slider.index')); ?>">
                            <i class="fa fa-briefcase"></i>
                            <span class="title">
                                <?php echo app('translator')->getFromJson('global.slider.title'); ?>
                            </span>
                        </a>
                    </li>
                    <li class="<?php echo e($request->segment(2) == 'info' ? 'active active-sub' : ''); ?>">
                        <a href="<?php echo e(route('admin.info.index')); ?>">
                            <i class="fa fa-briefcase"></i>
                            <span class="title">
                                <?php echo app('translator')->getFromJson('global.info.title'); ?>
                            </span>
                        </a>
                    </li>
                </ul>

            ...
            <div class="section-content">
                <div class="row">
                    ...
                    <?php endif; ?>
                            ...
                            <form role="form" class="mt-20" method="POST" action="<?php echo e(url('password/reset')); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                <input type="hidden" name="token" value="<?php echo e($token); ?>">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group mb-20">
                                            <input placeholder="<?php echo app('translator')->getFromJson('global.login.LOGIN_FORM_EMAIL'); ?>" name="email" class="form-control" type="email" value="<?php echo e(old('email')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group mb-20">
                                            <input placeholder="<?php echo app('translator')->getFromJson('global.login.LOGIN_FORM_PASSWORD'); ?>" name="password" class="form-control" type="password">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group mb-20">
                                            <input placeholder="<?php echo app('translator')->getFromJson('global.login.LOGIN_FORM_PASSWORD'); ?>" name="password_confirmation" class="form-control" type="password">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-0 mt-10">
                                            <button name="reset" type="submit" class="btn btn-colored btn-theme-colored2 text-white btn-lg btn-block"> <?php echo app('translator')->getFromJson('global.contact.CONTACT_FORM_RESET'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </form>

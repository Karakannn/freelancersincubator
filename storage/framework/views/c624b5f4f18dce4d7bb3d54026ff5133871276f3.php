<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <?php if($course->header_image): ?>
                        <a href="<?php echo e(asset('uploads/'.$course->header_image)); ?>" target="_blank"><img src="<?php echo e(asset('uploads/thumb/'.$course->header_image)); ?>"></a>
                    <?php endif; ?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <?php if($course->course_image): ?>
                        <a href="<?php echo e(asset('uploads/'.$course->course_image)); ?>" target="_blank"><img src="<?php echo e(asset('uploads/thumb/'.$course->course_image)); ?>"></a>
                    <?php endif; ?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <?php echo Form::select('course_type', $course_type, old('course_type') ? old('course_type') : $course_type->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => '']); ?>

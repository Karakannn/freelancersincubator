    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-xs-12 form-group">
                ...
                <?php echo Form::select('role[]', $roles, old('role'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'required' => '']); ?>
        ...
        <div class="row">
            <div class="col-xs-12 form-group">
                <?php echo Form::label('website_url', 'Webiste url', ['class' => 'control-label']); ?>

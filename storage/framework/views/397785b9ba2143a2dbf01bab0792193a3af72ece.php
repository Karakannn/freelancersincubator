                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8">
                            ...
                            <div class="pt-20">
                                ...
                                <h4><?php echo app('translator')->getFromJson('global.ACCOUNT.NO_COURSES'); ?></h4>
                                <?php endif; ?>
                                            ...
                                            <div class="course-single-item bg-white border-1px clearfix mb-30 cut-text">
                                                ...
                                                <div class="course-details clearfix p-20 pt-15">
                                                    ...
                                                    <p class="course-description mt-15 mb-0">
                                                        <?php echo e(str_limit(strip_tags($single_video->description), $limit = 80, $end = '...')); ?>

                                                    </p>
                                                    <?php if($single_video->name): ?>

<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(['method' => 'POST', 'route' => ['admin.slider.store'], 'files' => true,]); ?>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <?php echo Form::text('button_text', old('button_text'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']); ?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <?php echo Form::text('button_url', old('button_url'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']); ?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <?php echo Form::label('image', 'Slide image', ['class' => 'control-label']); ?>

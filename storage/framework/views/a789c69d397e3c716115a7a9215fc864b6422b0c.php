            ...
            <div class="container pt-60 pb-20">
                <div class="col-sm-6 col-md-3">
                    <div class="widget dark">
                        <img alt="" src="<?php echo e(asset('uploads/' . $info[0]->image)); ?>">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="widget dark">
                        <h4 class="widget-title line-bottom-theme-colored2"><?php echo app('translator')->getFromJson('global.home.LATEST_VIDEOS.LATEST_VIDEOS_TITLE'); ?></h4>
                        <div class="latest-posts">
                            <?php $__currentLoopData = $video->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single_video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="post media-post clearfix pb-0 mb-10">
                                <a class="post-thumb" href="<?php echo e(route('courses.show', [$single_video->slug])); ?>"><img class="img-55" src="<?php echo e($single_video->course_image == '' ? 'http://placehold.it/80x55' : asset('uploads/' . $single_video->course_image)); ?>" alt=""></a>
                                <div class="post-right">
                                    <h5 class="post-title mt-0 mb-5"><a href="<?php echo e(route('courses.show', [$single_video->slug])); ?>"><?php echo e($single_video->title); ?></a></h5>
                                </div>
                            </article>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        ...
                        <div class="col-md-6 text-right">
                            <div class="widget no-border m-0">
                                <ul class="list-inline sm-text-center mt-5 font-14">
                                    <li>
                                       <a href="<?php echo e(route('terms.index')); ?>"><?php echo app('translator')->getFromJson('global.home.REGISTER.REGISTER_FORM_T&C'); ?></a>
                                    </li>
                                    <li>|</li>
                                    <li>

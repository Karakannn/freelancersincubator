...
<?php echo Form::model($blogs, ['method' => 'PUT', 'route' => ['admin.blogs.update', $blogs->id], 'files' => true,]); ?>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-xs-12 form-group">
                <?php if($blogs->header_image): ?>
                <a href="<?php echo e(asset('uploads/'.$blogs->header_image)); ?>" target="_blank"><img src="<?php echo e(asset('uploads/thumb/'.$blogs->header_image)); ?>"></a>
                <?php endif; ?>
        ...
        <div class="row">
            <div class="col-xs-12 form-group">
                <?php if($blogs->image): ?>
                <a href="<?php echo e(asset('uploads/'.$blogs->image)); ?>" target="_blank"><img src="<?php echo e(asset('uploads/thumb/'.$blogs->image)); ?>"></a>
                <?php endif; ?>

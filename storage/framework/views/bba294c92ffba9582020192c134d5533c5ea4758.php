                        ...
                        <div class="course-single-item bg-white border-1px clearfix mb-30 cut-text">
                            ...
                            <div class="course-details clearfix p-20 pt-15">
                                <div class="course-top-part">
                                    ...
                                    <h5 class="text-gray font-12 mt-0"><?php echo e($single_course->start_date == '' ? '' : date('dS F', strtotime($single_course->start_date))); ?> <?php if($single_course->start_time): ?> @ <?php echo e(date('h:m A', strtotime($single_course->start_time))); ?> <?php endif; ?> EST</h5>
                                </div>
                                <p class="course-description mt-15 mb-0">
                                    <?php echo e(str_limit(strip_tags($single_course->description), $limit = 80, $end = '...')); ?>

                                </p>
                                <?php if($single_course->name): ?>

                    ...
                    <div class="col-md-6">
                        <div class="bg-dark-transparent-4 p-30 mt-0" style="min-height: 400px;">
                            ...
                            <div class='alert alert-danger'>
                                You haven't confirmed your email! If you haven't received the confirmation email please <a href = "<?php echo e(route('auth.resendemail', session('error'))); ?>">click here</a>
                            </div>
                            <?php endif; ?>

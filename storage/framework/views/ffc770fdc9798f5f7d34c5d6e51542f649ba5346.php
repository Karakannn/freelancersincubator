    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-xs-12 form-group">
                ...
                <?php echo Form::text('client', old('client'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']); ?>
        ...
        <div class="row">
            <div class="col-xs-12 form-group">
                ...
                <?php echo Form::text('position', old('position'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']); ?>
        ...
        <div class="row">
            <div class="col-xs-12 form-group">
                ...
                <?php echo Form::textarea('title', old('title'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']); ?>

        ...
        <div class="container">
            <div class="section-content">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img class="img-fullwidth" src="<?php echo url('/imgs/ab1.jpg');; ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container pt-20">
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        <img class="img-fullwidth hidden-md" src="<?php echo url('/imgs/ab2.jpg');; ?>" alt="">
                    </div>
                    <div class="col-md-6">
        ...
        <div class="container">
            <div class="section-content">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img class="img-fullwidth" src="<?php echo url('/imgs/ab3.jpg');; ?>" alt="">
                    </div>
                </div>
            </div>
        </div>

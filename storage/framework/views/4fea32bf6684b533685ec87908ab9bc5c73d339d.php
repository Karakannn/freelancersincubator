    ...
    <!-- Section: inner-header -->
        ...
        <div class="container pt-120 pb-60">
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="text-theme-colored2 font-36"><?php echo e($category->name); ?> Posts</h2>
                            ...
                            <article class="post clearfix mb-30 bg-lighter">
                                <div class="entry-header">
                                    <div class="post-thumb thumb">
                                        <img src="<?php echo e($single_blog->header_image == '' ? 'http://placehold.it/540x480' : asset($single_blog->header_image)); ?>" alt="" class="img-responsive img-fullwidth">
                                    </div>
                                </div>
                                    ...
                                    <div class="entry-meta media mt-0 no-bg no-border">
                                        ...
                                        <div class="media-body pl-15">
                                            <div class="event-content pull-left flip">
                                                <h4 class="entry-title text-white text-uppercase m-0 mt-5"><a href="<?php echo e(route('blogs.show', [$single_blog->id])); ?>"><?php echo e($single_blog->title); ?></a></h4>
...
<!--                                                <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-heart-o mr-5 text-theme-colored"></i> 895 Likes</span>-->
                                    ...
                                    <a href="<?php echo e(route('blogs.show', [$single_blog->id])); ?>" class="btn-read-more">Read more</a>
